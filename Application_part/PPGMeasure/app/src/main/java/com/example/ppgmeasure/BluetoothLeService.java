...
public class BluetoothLeService extends Service {
    private final static String TAG = com.example.ppgmeasure.BluetoothLeService.class.getSimpleName();
    ...
    public class LocalBinder extends Binder {
        com.example.ppgmeasure.BluetoothLeService getService() {
            return com.example.ppgmeasure.BluetoothLeService.this;
        }
    }
     ...
     *
     */
    public void writeCharacteristic(BluetoothGattCharacteristic characteristic, byte[] cmd_str){
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            Log.w(TAG, "BluetoothAdapter not initialized");
            return;
        }
