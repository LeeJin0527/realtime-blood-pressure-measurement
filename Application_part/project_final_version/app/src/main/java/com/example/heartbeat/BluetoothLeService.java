...
public class BluetoothLeService extends Service {
    private final static String TAG = com.example.heartbeat.BluetoothLeService.class.getSimpleName();
    ...
    public class LocalBinder extends Binder {
        com.example.heartbeat.BluetoothLeService getService() {
            return com.example.heartbeat.BluetoothLeService.this;
        }
    }
